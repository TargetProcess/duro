...
two_trees_and_a_cycle = nx.DiGraph(
    [[1, 2], [1, 3], [1, 4], [1, 5], [6, 7], [6, 8], [9, 10], [10, 11], [11, 9]]
)

two_cycles = nx.DiGraph(
...
def test_detect_cycles():
    graphs = [simple_tree, two_trees_and_a_cycle, two_cycles, simple_cycle]
    results = []
    for graph in graphs:
